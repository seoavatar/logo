...
<head>
    ...
    <style>
        ...
        body {
            background-image: url(https://res.cloudinary.com/dc1hapmew/image/upload/v1749015561/matrix-effect-with-code-rain-animation-photoshop-tutorial_fav8i9.gif);
            font-family: monospace
        }
